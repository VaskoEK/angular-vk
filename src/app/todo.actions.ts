...
export const incompleteTodo = createAction('[Todo] incomplete todo', props<{id:number}>());
...
export const completeTodoAfterApi = createAction('[Todo] complete todo after api', props<{id:number}>());
export const incompleteTodoAfterApi = createAction('[Todo] incomplete todo after api', props<{id:number}>());